...
Every tail claim and every round-to-round spread in RESULTS-EPHPM.md is built
from this instead: it pulls P50/P75/P90/P99 and keeps each round as its own
row, so an averaged number can always be traced back to the rounds behind it.
